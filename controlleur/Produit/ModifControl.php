...
if(isset($_POST['id']) && isset($_POST['nom']) && isset($_POST['prix']) && isset($_POST['description']) && isset($_POST['TypeProduit']) && isset($_FILES['image']) ){
   ...
   $error=$_FILES['image']['error'];
    ...
    if (in_array($img_ex_lc,$allowed_exs)){
        ...
        $oProduit->Update($nom,$prix,$description,$typeProduit,$new_img_name,$id);
