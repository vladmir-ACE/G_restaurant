        ...
        ***********************************-->
                 ...
                 <div class="card" style="width:60%;" >
                            <div class="card-header">
                                <h4 class="card-title">Save Commande</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form method='post' action="../../controlleur/Commande/ajoutControl.php">
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for='titre'>Nom du client</label>
                                            <div class="col-sm-10">
                                                <input type="text" id='titre'name="nom_client" class="form-control" placeholder="Nom du client">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for='titre'>Prenom du client</label>
                                            <div class="col-sm-10">
                                                <input type="text" id='titre'name="Prenom_client" class="form-control" placeholder="Prenom du client">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for='titre'>TEL</label>
                                            <div class="col-sm-10">
                                                <input type="text" id='titre'name="TEL" class="form-control" placeholder="Telephone du client">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label" for='Qachat'>Quantité acheté</label>
                                            <div class="col-sm-10">
                                                <input type="number" id='Qachat'name="Qachat" class="form-control" placeholder="Quantité acheté">
                                            </div>
                                        </div>
                                        <div class="form-group row">
