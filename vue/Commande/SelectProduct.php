                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">PLATS ET BOISSON D'ISPONIBLES</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example" class="display " style="min-width: 845px ">
                                      ...
                                      <a class="btn btn-primary" role="button" href="AfficheSaveControl.php?id=<?php echo$DATA['id'];?>"><i class="dw dw-edit2"></i>COMMANDER</a>
