                                    ...
                                    <table id="example" class="display " style="min-width: 845px ">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?php echo $DATA['typeProduit'];?></td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                                                            ...
                                                            <a class="dropdown-item" href="premodifControl.php?id=<?php echo$DATA['id'];?>"><i class="dw dw-edit2"></i> Edit</a>
                                                            <a class="dropdown-item" href="deleteControl.php?id=<?php echo $DATA['id'];?>"><i class="dw dw-delete-3"></i> Delete</a>
                                                        </div>
                                                    </div>
									           </td>
